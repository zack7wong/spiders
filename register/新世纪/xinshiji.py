...
def get_img():
    ...
    verify_url = 'http://www.xsj280.com/Home/login/verify.html'
...
def login(username, password, code):
    ...
    headers = {
        ...
        'Host': "www.xsj280.com",
        'Origin': "http://www.xsj280.com",
        'Pragma': "no-cache",
        'Referer': "http://www.xsj280.com/home/index/index.html",
    ...
    login_url = 'http://www.xsj280.com/home/Login/logined'
...
def click(start_url):
    ...
    yuer = html.xpath('string(//div[@class="fr"])')
    print(content)
    print(yuer.strip())
...
def logout(start_url):
    ...
    logout_url = 'http://www.xsj280.com/home/login/logout.html'
...
if __name__ == '__main__':
    ...
    # start_url = 'http://www.xsj280.com/home/usercenter/redpack/rid/RR812MGW82HOX96TD2EZ'
    account_list = []
