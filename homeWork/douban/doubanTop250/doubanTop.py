...
headers = {
    ...
    # 'Cookie': 'bid=jiPiWxCsnbg; ll="118282"; _vwo_uuid_v2=DBCE20527FFC5F06CAEE989D0D0A1CA6E|d3a1206da68d4dffd70ab6cfdb29e357; _ga=GA1.2.2071961702.1531198334; douban-profile-remind=1; douban-fav-remind=1; viewed="6049132"; gr_user_id=c902b75b-be37-423a-8589-cd0a81e33537; __yadk_uid=TNAAa6V3q1b0pjypK2OWoVq0XWqwrxlC; __utmz=223695111.1550920499.4.3.utmcsr=accounts.douban.com|utmccn=(referral)|utmcmd=referral|utmcct=/passport/login; push_noty_num=0; push_doumail_num=0; dbcl2="192293664:3s//jYMlAXk"; __utmv=30149280.19229; ct=y; __utmz=30149280.1552644645.51.23.utmcsr=google|utmccn=(organic)|utmcmd=organic|utmctr=(not%20provided); _pk_ref.100001.4cf6=%5B%22%22%2C%22%22%2C1553423248%2C%22https%3A%2F%2Faccounts.douban.com%2Fpassport%2Flogin%3Fredir%3Dhttps%253A%252F%252Fmovie.douban.com%252Fexplore%22%5D; _pk_ses.100001.4cf6=*; ap_v=0,6.0; __utma=30149280.2071961702.1531198334.1552644645.1553423249.52; __utmb=30149280.0.10.1553423249; __utmc=30149280; __utma=223695111.2071961702.1531198334.1552373181.1553423249.8; __utmb=223695111.0.10.1553423249; __utmc=223695111; _pk_id.100001.4cf6=4d713e5636800d95.1550840314.8.1553424225.1552373269.',
...
def start():
    for i in range(11,12):
        ...
        for url in urls:
            ...
            sql = "insert into info(movieId,MovieName,EnglishName,OtherName,Director,Actors,Year,Country,Grenre,Rating,RatingNum,Description) values ('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s') " %(movieId,MovieName,EnglishName,OtherName,Director,Actors,Year,Country,Grenre,Rating,RatingNum,Description)
