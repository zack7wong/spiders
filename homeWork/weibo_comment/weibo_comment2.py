...
max_id = 0
while True:
    commentDetailUrl = 'https://m.weibo.cn/comments/hotflow?id=4307035456256204&mid=4307035456256204&max_id={max_id}&max_id_type=0'.format(max_id=max_id)
    ...
    if 'data' in json_detail and 'data' in json_detail['data']:
        for each in json_detail['data']['data']:
            ...
            save_res = userId+','+userName+','+commentTime+','+commentText+','+userUrl+'\n'
            print(save_res)
