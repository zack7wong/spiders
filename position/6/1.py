...
id_list = []
def start():
    start_url = 'http://career.sspu.edu.cn/eweb/wfc/app/pager.so?type=goPager&requestPager=pager&pageMethod=next&currentPage={pageToken}'
    for i in range(0,6):
        ...
        for item in url_list:
            ...
            if id in id_list:
                ...
                id_list.append(id)
            link = 'http://career.sspu.edu.cn/eweb/jygl/zpfw.so?modcode=jygl_scfwzpxx&subsyscode=zpfw&type=viewZpxx&id='+id
            print(link)
